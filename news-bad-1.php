...
<article itemscope itemtype="https://schema.org/NewsArticle" class="mt-4">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <h1 itemprop="headline" class="mb-4">The Obfuscation of Municipal Methodologies</h1>
            <div class="text-muted mb-4">
                By <span itemprop="author" itemscope itemtype="https://schema.org/Person"><span itemprop="name">Verbose Writer</span></span> | 
